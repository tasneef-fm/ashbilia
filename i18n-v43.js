...
(() => {
  ...
  const AR_EN={
    ...
    '📷 تصوير الصنف بالكاميرا':'📷 Take Product Photo','جاري ضغط الصورة...':'Compressing image...','عدد الملصقات لكل صنف':'Labels per product','توليد الباركودات':'Generate Barcodes','طباعة الباركودات':'Print Barcodes',
